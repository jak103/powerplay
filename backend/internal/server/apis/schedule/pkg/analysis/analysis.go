	...
	for _, league := range []string{"A", "B", "C", "D"} {
		...
		for _, team := range teams {
			...
			if stats.League == league {
				...
				fmt.Printf("Average days between games: %0.1f\n", stats.AverageDaysBetweenGames)
			}
		}
	}
}
