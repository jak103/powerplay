...
const userInfo = {
  ...
  "teams": [{
    name: "Trash Pandas",
    logo: "/_nuxt/assets/trash-panda.webp"
  },
  {
    name: "District 5",
    logo: "/_nuxt/assets/District-5.webp"
  }],
  "leagues": ["C", "D"]
}
export default {
...
<template>
  ...
  <img src="../../../assets/ProfilePic.webp" width="100" height="100" class="profile-image-container">
  <NuxtLink class="btn btn-primary" to="/app/sign-in" id="btn-image" style="font-size: 0px;">
  ...
  <div class="container">
    ...
    <div class="teams-container">
      <h4 class="teams-heading">Teams</h4>
      <ul>
        <li v-for="team in teams">
          <img :src="team.logo" width="25" height="25" class="team-logo"> {{
            team.name }}
        </li>
      </ul>
    </div>
    <div class="teams-container">
      <h4 class="teams-heading">Leagues</h4>
      <ul>
        <li v-for="league in leagues">
          <img :src="'/_nuxt/assets/' + league + '.jpeg'" width="25" height="25" class="team-logo"> {{ league }}-League
        </li>
      </ul>
