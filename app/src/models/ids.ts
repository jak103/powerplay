...
export type UserId = Branded<unknown, 'user_id'>
export type SeasonId = Branded<unknown, 'season_id'>
export type VenueId = Branded<unknown, 'venue_id'>
export type RosterId = Branded<unknown, 'roster_id'>
export type GameId = Branded<unknown, 'game_id'>
export type PenaltyTypeId = Branded<unknown, 'penalty_type_id'>
